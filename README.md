...
**Ant Design Pro 越写越复杂，权限菜单，多语言我也是服了，fork 一份自己用了。删除 docker/firebase/国际化/测试/typescript/md，用户登录注册/API权限使用 jwt token，和 Django/DRF 脚手架 https://github.com/lsdlab/ade 配合使用**
